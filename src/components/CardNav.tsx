...
export const CardNav: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 w-[92%] max-w-7xl z-50">
      <nav
        ref={navRef}
        className="bg-[#FAF9F6]/90 backdrop-blur-md border border-[#E4E2DC] rounded-2xl shadow-xl shadow-black/5 overflow-hidden transition-all duration-300 ease-out relative"
      ...
      >
        ...
        >
          {items.map((item, idx) => (
            <div
              key={idx}
              className="bg-white border border-[#E4E2DC] rounded-xl p-5 flex flex-col justify-between shadow-sm"
            >
              <div>
